...
function main() {
  ...
  const payload = {
    ...
    inputs: {
      available: ["Canonical player identity", "Current team", "Depth chart", "Historical rush/receiving touchdowns", "Red-zone carries and targets", "Inside-the-10 carries and targets", "Recent-six-game opportunity", "Roster-reported availability"],
      gated: ["Regular-season role confirmation", "Opponent assignment", "Defense-versus-position context", "Routes and snap participation", "Team implied total", "Spread and game total", "Weather", "Verified Anytime TD price", "Quote freshness"]
    },
    weights: { goalLineOpportunity: 0.32, redZoneOpportunity: 0.20, touchdownHistory: 0.20, roleCertainty: 0.23, recentOpportunity: 0.05 },
    counts: {
  ...
  health.status = "td_shadow_board_ready_projections_gated";
