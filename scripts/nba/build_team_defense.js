...
async function main() {
  ...
  const out = {
    ...
    modelNotes: [
      "Team Defense 1.0 uses NBA stats opponent per game team data.",
      "Lower allowed values rank as stronger defense.",
      "This endpoint does not provide pace or defensive rating, so this file uses real opponent allowed box score data only.",
