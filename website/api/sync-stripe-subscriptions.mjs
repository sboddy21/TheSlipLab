...
const PLAN_ENV_KEYS = {
  weekly: ["STRIPE_PRICE_ID_WEEKLY_CURRENT", "TSL_STRIPE_PRICE_ID_WEEKLY_CURRENT", "STRIPE_PRICE_ID_WEEKLY", "TSL_STRIPE_PRICE_ID_WEEKLY"],
  monthly: ["STRIPE_PRICE_ID_MONTHLY_CURRENT", "TSL_STRIPE_PRICE_ID_MONTHLY_CURRENT", "STRIPE_PRICE_ID_MONTHLY", "TSL_STRIPE_PRICE_ID_MONTHLY", "STRIPE_PRICE_ID", "TSL_STRIPE_PRICE_ID"],
  annual: ["STRIPE_PRICE_ID_ANNUAL_CURRENT", "TSL_STRIPE_PRICE_ID_ANNUAL_CURRENT", "STRIPE_PRICE_ID_ANNUAL", "STRIPE_PRICE_ID_ANNUALLY", "TSL_STRIPE_PRICE_ID_ANNUAL", "TSL_STRIPE_PRICE_ID_ANNUALLY"]
};
